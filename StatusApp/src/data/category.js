...
export const Categories = [
    new Category( 'c1' , 'Cool Status'),
    new Category( 'c2' , 'Funny Status'),
    new Category( 'c3' , 'Motivational Status'),
    ...
    new Category( 'c11' , 'Chirstmas Status'),
    new Category( 'c12' , 'Status for Her'),
